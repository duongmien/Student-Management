...
contactMAP: function (){
	...
	function init_gmap() {
		...
		var options = {
			...
			{elementType: 'https://jthemes.net/themes/html/genius-course/assets/js/labels.text.fill', stylers: [{color: '#eeeeee'}]},
			{
				featureType: 'administrative.locality',
				elementType: 'https://jthemes.net/themes/html/genius-course/assets/js/labels.text.fill',
			...
			{
				featureType: 'https://jthemes.net/themes/html/genius-course/assets/js/poi.park',
		...
		$('#googleMaps').gmap3({
			...
			marker: {
				...
				options: { icon: 'assets/img/map.png'/*tpa=https://jthemes.net/themes/html/genius-course/assets/js/assets/img/map.png*/ }
